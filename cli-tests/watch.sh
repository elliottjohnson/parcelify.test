...
function WATCH_TEST() {
    ...
    debug_echo "  $PARCELIFY $DEBUG_PARCELIFY -w $MAINJS -c $WATCH &"

    $PARCELIFY $DEBUG_PARCELIFY -w $MAINJS -c $WATCH &
    ...
    debug_echo "Sleeping for one second to be sure watchify picks up on it."
    sleep 1
    ...
    debug_echo "waiting 1 second for watchify to pickup on the missing css file."
    sleep 1
